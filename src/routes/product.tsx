...
const productJsonLd = {
  ...
  description:
    'Семейство Concrete Canvas: CCT — универсальное решение, CC Hydro — герметичный экран, CCX — облицовка гидросооружений, DEPLOY — быстровозводимые резервуары.',
  brand: {
    '@type': 'Brand',
  ...
  return (
    <>
      ...
      <Section
        ...
        eyebrow="Линейка CC Hydro"
        title="CC Hydro (ССНТ) — сдерживание реагентов"
        description="Сочетает технологию ГЦКМ и химически стойкую геомембрану (ПВХ 1.0 мм). Разработан для защитных обваловок, накопителей и хвостовых тоннелей в проектах добычи и хранения полезных ископаемых."
      >
